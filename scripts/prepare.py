...
def main():
    ...
    ap.add_argument("--model", default="sensevoice", choices=["sensevoice", "paraformer", "moss"],
                   help="本地 ASR 模型（仅 local 模式生效）：sensevoice=快速档 GGUF 纯CPU（默认）| moss=精准档端到端 | paraformer=旧全精度引擎；档位选择见 SKILL.md Step 2.5")
